...
Depends on the tools module path helpers. Before writing, the tool resolves the destination path and applies workspace-boundary checks. Blocked destinations are not written.
