...
Depends on the tools module path helpers. Before reading, the tool resolves the target path and applies the active workspace filesystem settings. No file content is returned for blocked paths.
