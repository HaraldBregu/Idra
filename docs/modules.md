...
| --- | --- | --- | --- |
| Task scheduler | `taskScheduler` | [task-scheduler.md](tasks/task-scheduler.md) | Service, IPC, LLM tool `cron` |
| Background task | `backgroundTask` | [background-task.md](tasks/background-task.md) | Service, IPC, LLM tool `task` |
