...
This page summarizes OpenAI Agent Skills usage from official OpenAI docs checked
on May 22, 2026. It is intentionally paraphrased rather than copied from the
source page.
...
Hosted shell supports uploaded `skill_reference` attachments, including curated
skills and explicit versions.
