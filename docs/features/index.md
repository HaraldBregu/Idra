...
| [Multiprovider and multimodel support](providers-and-models.md)         | Partial runtime                           | Assistant runtime supports Anthropic, OpenAI, Mistral, DeepSeek, Qwen, and OpenAI-compatible providers. Speech-to-text has runtime adapters for six providers. Other model services have catalogs or settings surfaces pending runtime.        |
