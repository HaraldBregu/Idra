...
- [Feature overview](#feature-overview)
  ...
  - [Channels: chat from anywhere](#9-channels-chat-from-anywhere)
  - [Task scheduler](#10-task-scheduler)
  - [Health checks](#11-health-checks)
  - [Memory and personalization](#12-memory-and-personalization)
