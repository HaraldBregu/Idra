/**
 * Usage guide for src/main/agent_v2/model.
 *
 * The model package exposes one public module: AgentModel.
 ...
 * AgentModel owns the translation from simple model messages to the LLM
