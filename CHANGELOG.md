...
- New settings pages for general preferences, persona, permissions, data, cloud, extensions, embeddings, RAG, realtime voice, provider keys, tasks, and wiki.
- Broader unit, integration, and end-to-end coverage for the agent runtime, permissions, sessions, providers, extensions, channels, MCP, RAG, realtime voice, storage, settings, and media.
...
- Redesigned settings navigation around general, assistant, services, cloud, channels, and extension groups.
...
- Legacy widgets in favor of extensions.
