...
jest.mock('react-i18next', () => {
	const translations: Record<string, string> = {
		...
		'settings.rag.scheduleEvery4Hours': 'Every 4 hours',
		'settings.rag.scheduleEvery12Hours': 'Every 12 hours',
		'settings.rag.scheduleEveryDay': 'Every day',
		'settings.rag.scheduleEveryWeek': 'Every week',
