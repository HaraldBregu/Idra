...
it('purges only an explicitly scoped remote namespace and never the Pinecone index', async () => {
	...
	const scope = {
		...
		generation: 'idra-11111111-1111-4111-8111-111111111111',
	};
...
it('purges all Idra namespaces without deleting unrelated namespaces or the index', async () => {
	listNamespaces
		.mockResolvedValueOnce({
			namespaces: [
				{ name: 'idra-11111111-1111-4111-8111-111111111111' },
				{ name: 'another-application' },
			],
			pagination: { next: 'page-2' },
		})
		.mockResolvedValueOnce({
			namespaces: [{ name: 'idra-22222222-2222-4222-8222-222222222222' }],
		});
	const controller = new DataController({
		config: { location: '/workspace' },
		listSessions: () => [],
	...
	expect(listNamespaces).toHaveBeenNthCalledWith(1, { prefix: 'idra-', limit: 100 });
	...
	expect(deleteNamespace.mock.calls.map(([namespace]) => namespace)).toEqual([
		'idra-11111111-1111-4111-8111-111111111111',
		'idra-22222222-2222-4222-8222-222222222222',
	]);
