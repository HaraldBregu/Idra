...
jest.mock('../../../../src/main/models/stt/stt_openai', () => ({ createOpenAISttAdapter: openai }));
jest.mock('../../../../src/main/models/stt/stt_deepgram', () => ({ createDeepgramSttAdapter: deepgram }));
jest.mock('../../../../src/main/models/stt/stt_elevenlabs', () => ({ createElevenLabsSttAdapter: mk('e') }));
jest.mock('../../../../src/main/models/stt/stt_mistral', () => ({ createMistralSttAdapter: mk('m') }));
jest.mock('../../../../src/main/models/stt/stt_qwen', () => ({ createQwenSttAdapter: mk('q') }));
jest.mock('../../../../src/main/models/stt/stt_xai', () => ({ createXaiSttAdapter: mk('x') }));

import { buildSttAdapter } from '../../../../src/main/models/stt/stt_factory';
import { SttProviderUnsupportedError } from '../../../../src/main/models/stt/stt_errors';
import type { SttProviderSpec } from '../../../../src/main/models/stt/stt_types';
