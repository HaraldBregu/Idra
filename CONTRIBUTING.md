...
npm pack --dry-run --workspace @idra/sdk
npm pack --dry-run --workspace @idra/cli
```
...
Open a GitHub issue at the [project repository](https://github.com/HaraldBregu/idra) with steps to reproduce, expected vs. actual behavior, and your platform (OS, app version). For security vulnerabilities, do **not** open a public issue — follow [SECURITY.md](SECURITY.md) instead.
