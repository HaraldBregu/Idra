...
function PageSidebarLayoutInset({ className, ...props }) {
    return (_jsx("main", { "data-slot": "sidebar-inset", className: cn('relative flex w-full flex-1 flex-col bg-transparent md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2', className), ...props }));
}
function PageSidebarLayoutInput({ className, ...props }) {
    return (_jsx(Input, { "data-slot": "sidebar-input", "data-sidebar": "input", className: cn('h-8 w-full bg-background/70 shadow-none supports-backdrop-filter:backdrop-blur-xl', className), ...props }));
}
