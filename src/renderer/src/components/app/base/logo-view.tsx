...
export function LogoView(): React.JSX.Element {
	return (
		<div className="flex flex-col items-center gap-4">
			...
			>
				<div className="absolute -left-10 top-[108px] h-11 w-[340px] rounded-[50%] border-2 border-fuchsia-500 shadow-[0_0_10px_#ec4899]" />
				<div className="absolute -left-10 top-[108px] h-11 w-[340px] rounded-[50%] border-2 border-orange-400 shadow-[0_0_10px_#fb923c] [clip-path:inset(0_0_0_50%)]" />
				...
				<div className="absolute -left-10 top-[108px] z-20 h-11 w-[340px] rounded-[50%] border-2 border-fuchsia-400 shadow-[0_0_10px_#f472b6] [clip-path:inset(50%_0_0_0)]" />
				<div className="absolute -left-10 top-[108px] z-20 h-11 w-[340px] rounded-[50%] border-2 border-orange-300 shadow-[0_0_10px_#fdba74] [clip-path:inset(50%_0_0_50%)]" />
			</div>
