...
export function LogoView(): React.JSX.Element {
	return (
		<div>
			...
			>
				<div
					className="absolute -left-10 top-[114px] h-8 w-[340px] rounded-[50%] p-1.5 drop-shadow-[0_0_8px_rgba(244,63,94,0.9)]"
					style={ORBIT_STYLE}
				/>
				...
				<div
					className="absolute -left-10 top-[114px] z-20 h-8 w-[340px] rounded-[50%] p-1.5 drop-shadow-[0_0_8px_rgba(251,113,133,0.85)] [clip-path:inset(50%_0_0_0)]"
					style={ORBIT_STYLE}
				/>
			</div>
		</div>
