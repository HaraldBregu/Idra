...
export function VoiceOrbNeptune() {
    ...
    return (_jsxs("div", { className: "flex flex-col items-center gap-4", children: [_jsxs("div", { role: "button", tabIndex: 0, "aria-label": `Voice agent (Neptune), mode: ${mode}. Click to change.`, className: "relative cursor-pointer", style: { width: 260, height: 260 }, onClick: cycleMode, onKeyDown: (e) => {
                    if (e.key === 'Enter' || e.key === ' ')
                        cycleMode();
                }, children: [_jsx("div", { ref: mountRef, style: { width: 260, height: 260, borderRadius: '50%', overflow: 'hidden' } }), _jsx("div", { ref: ring1Ref, className: "pointer-events-none absolute rounded-full", style: {
                            inset: -18,
                            ...
                            opacity: 0,
                            transition: 'opacity 0.06s',
                        } })] }), _jsxs("div", { className: "flex items-center gap-2", style: { height: 22 }, children: [_jsx("div", { className: "size-2 rounded-full", style: {
                            ...
                            animation: cfg.blink ? 'voiceOrbNeptuneBlink 1.3s ease-in-out infinite' : 'none',
                        }, children: cfg.label })] }), _jsx("p", { className: "text-center text-sm", style: { color: 'rgba(20,55,150,0.68)', maxWidth: 288, lineHeight: 1.68, minHeight: 72 }, children: cfg.message }), _jsx("canvas", { ref: waveRef, width: 300, height: 44, style: { width: 150, height: 22, opacity: cfg.waveform ? 1 : 0, transition: 'opacity 0.4s' } }), _jsx("style", { children: `
