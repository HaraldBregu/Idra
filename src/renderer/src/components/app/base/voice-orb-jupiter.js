...
export function VoiceOrbJupiter() {
    ...
    return (_jsxs("div", { className: "flex flex-col items-center gap-4", children: [_jsxs("div", { role: "button", tabIndex: 0, "aria-label": `Voice agent (Jupiter), mode: ${mode}. Click to change.`, className: "relative cursor-pointer", style: { width: 260, height: 260 }, onClick: cycleMode, onKeyDown: (e) => {
                    if (e.key === 'Enter' || e.key === ' ')
                        cycleMode();
                            ...
                            animation: cfg.blink ? 'voiceOrbJupiterBlink 1.3s ease-in-out infinite' : 'none',
                        }, children: cfg.label })] }), _jsx("p", { className: "text-center text-sm", style: { color: 'rgba(100,60,15,0.68)', maxWidth: 288, lineHeight: 1.68, minHeight: 72 }, children: cfg.message }), _jsx("canvas", { ref: waveRef, width: 300, height: 44, style: { width: 150, height: 22, opacity: cfg.waveform ? 1 : 0, transition: 'opacity 0.4s' } }), _jsx("style", { children: `
