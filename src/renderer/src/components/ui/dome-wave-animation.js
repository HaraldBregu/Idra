...
const WAVES = [
    ...
    { amp: 0.24, freq: 2.4, ph: 1.3, sp: 0.65, cL: [0.08, 0.75, 0.70], cM: [0.22, 0.50, 0.92], cR: [0.52, 0.18, 0.84] },
    { amp: 0.32, freq: 1.4, ph: 4.2, sp: 0.48, cL: [0.14, 0.80, 0.68], cM: [0.16, 0.62, 0.96], cR: [0.40, 0.28, 0.90] },
    { amp: 0.18, freq: 2.7, ph: 2.8, sp: 1.05, cL: [0.30, 0.55, 0.85], cM: [0.12, 0.58, 0.98], cR: [0.50, 0.22, 0.82] },
    { amp: 0.26, freq: 1.2, ph: 5.5, sp: 0.40, cL: [0.10, 0.85, 0.74], cM: [0.20, 0.64, 0.94], cR: [0.46, 0.32, 0.88] },
    { amp: 0.22, freq: 2.9, ph: 0.4, sp: 1.18, cL: [0.38, 0.30, 0.90], cM: [0.15, 0.55, 0.96], cR: [0.48, 0.26, 0.86] },
    { amp: 0.16, freq: 3.3, ph: 3.0, sp: 1.30, cL: [0.18, 0.78, 0.65], cM: [0.10, 0.64, 0.99], cR: [0.54, 0.20, 0.82] },
];
...
function dome(x) { return Math.cos(x * Math.PI * 0.5); }
...
export function DomeWaveAnimation({ active = true, height = 80, className }) {
