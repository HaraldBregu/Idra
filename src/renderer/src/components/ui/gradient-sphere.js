...
`;
export function GradientSphere({ size = 20, className, mode = "webgl", state = "active", }) {
    ...
    if (mode === "css") {
        return (_jsx("div", { "aria-hidden": "true", className: cn("relative inline-flex shrink-0 overflow-hidden rounded-full bg-[radial-gradient(circle_at_34%_26%,#ffe39b_0%,#f0a24a_28%,#b12767_56%,#351353_100%)] shadow-[inset_-4px_-6px_12px_rgba(18,8,34,0.38),inset_3px_3px_8px_rgba(255,238,176,0.35)]", className), style: { width: size, height: size }, children: _jsx("span", { className: "absolute inset-0 rounded-full bg-[radial-gradient(circle_at_30%_20%,rgba(255,246,198,0.72),transparent_42%)]" }) }));
    }
    return (_jsx("div", { ref: mountRef, "aria-hidden": "true", className: cn("inline-flex shrink-0", className), style: { width: size, height: size } }));
}
