...
import ai21IconLight from '@resources/icons/model_providers/29_ai21_labs/fallback_lobehub/png_light/ai21.png';
import anthropicIconDark from '@resources/icons/model_providers/02_anthropic/fallback_lobehub/png_dark/anthropic.png';
import anthropicIconLight from '@resources/icons/model_providers/02_anthropic/fallback_lobehub/png_light/anthropic.png';
import baiduIconDark from '@resources/icons/model_providers/12_baidu_ernie/fallback_lobehub/png_dark/baidu-color.png';
import baiduIconLight from '@resources/icons/model_providers/12_baidu_ernie/fallback_lobehub/png_light/baidu-color.png';
import blackForestLabsIconDark from '@resources/icons/model_providers/21_black_forest_labs/official_downloaded_assets/bfl-symbol-white.png';
import blackForestLabsIconLight from '@resources/icons/model_providers/21_black_forest_labs/official_downloaded_assets/bfl-symbol-black.png';
import bytedanceSeedIconDark from '@resources/icons/model_providers/14_bytedance_seed/fallback_lobehub/png_dark/bytedance-color.png';
import bytedanceSeedIconLight from '@resources/icons/model_providers/14_bytedance_seed/fallback_lobehub/png_light/bytedance-color.png';
import cohereIconDark from '@resources/icons/model_providers/07_cohere/fallback_lobehub/png_dark/cohere-color.png';
import cohereIconLight from '@resources/icons/model_providers/07_cohere/fallback_lobehub/png_light/cohere-color.png';
import deepgramIcon from '@resources/icons/model_providers/17_deepgram/fallback_simpleicons/png/deepgram.png';
import deepseekIconDark from '@resources/icons/model_providers/08_deepseek/fallback_lobehub/png_dark/deepseek-color.png';
import deepseekIconLight from '@resources/icons/model_providers/08_deepseek/fallback_lobehub/png_light/deepseek-color.png';
import elevenlabsIconDark from '@resources/icons/model_providers/16_elevenlabs/fallback_lobehub/png_dark/elevenlabs.png';
import elevenlabsIconLight from '@resources/icons/model_providers/16_elevenlabs/fallback_lobehub/png_light/elevenlabs.png';
import googleIconDark from '@resources/icons/model_providers/03_google_google_deepmind_google_cloud/fallback_lobehub/png_dark/google-color.png';
import googleIconLight from '@resources/icons/model_providers/03_google_google_deepmind_google_cloud/fallback_lobehub/png_light/google-color.png';
import ideogramIconDark from '@resources/icons/model_providers/28_ideogram/fallback_lobehub/png_dark/ideogram.png';
import ideogramIconLight from '@resources/icons/model_providers/28_ideogram/fallback_lobehub/png_light/ideogram.png';
import kimiIconDark from '@resources/icons/model_providers/10_moonshot_ai_kimi/fallback_lobehub/png_dark/kimi-color.png';
import kimiIconLight from '@resources/icons/model_providers/10_moonshot_ai_kimi/fallback_lobehub/png_light/kimi-color.png';
import klingIconDark from '@resources/icons/model_providers/26_kuaishou_kling_ai/fallback_lobehub/png_dark/kling-color.png';
import klingIconLight from '@resources/icons/model_providers/26_kuaishou_kling_ai/fallback_lobehub/png_light/kling-color.png';
import lumaIconDark from '@resources/icons/model_providers/25_luma_ai/fallback_lobehub/png_dark/luma-color.png';
import lumaIconLight from '@resources/icons/model_providers/25_luma_ai/fallback_lobehub/png_light/luma-color.png';
import metaIconDark from '@resources/icons/model_providers/04_meta/fallback_lobehub/png_dark/meta-color.png';
import metaIconLight from '@resources/icons/model_providers/04_meta/fallback_lobehub/png_light/meta-color.png';
import midjourneyIconDark from '@resources/icons/model_providers/22_midjourney/fallback_lobehub/png_dark/midjourney.png';
import midjourneyIconLight from '@resources/icons/model_providers/22_midjourney/fallback_lobehub/png_light/midjourney.png';
import minimaxIconDark from '@resources/icons/model_providers/15_minimax_hailuo/fallback_lobehub/png_dark/minimax-color.png';
import minimaxIconLight from '@resources/icons/model_providers/15_minimax_hailuo/fallback_lobehub/png_light/minimax-color.png';
import mistralIconDark from '@resources/icons/model_providers/06_mistral_ai/fallback_lobehub/png_dark/mistral-color.png';
import mistralIconLight from '@resources/icons/model_providers/06_mistral_ai/fallback_lobehub/png_light/mistral-color.png';
import nvidiaIconDark from '@resources/icons/model_providers/31_nvidia_nemotron/fallback_lobehub/png_dark/nvidia-color.png';
import nvidiaIconLight from '@resources/icons/model_providers/31_nvidia_nemotron/fallback_lobehub/png_light/nvidia-color.png';
import openaiIconDark from '@resources/icons/model_providers/01_openai/fallback_lobehub/png_dark/openai.png';
import openaiIconLight from '@resources/icons/model_providers/01_openai/fallback_lobehub/png_light/openai.png';
import perplexityIconDark from '@resources/icons/model_providers/35_perplexity/fallback_lobehub/png_dark/perplexity-color.png';
import perplexityIconLight from '@resources/icons/model_providers/35_perplexity/fallback_lobehub/png_light/perplexity-color.png';
import qwenIconDark from '@resources/icons/model_providers/09_alibaba_group_alibaba_cloud_qwen/fallback_lobehub/png_dark/qwen-color.png';
import qwenIconLight from '@resources/icons/model_providers/09_alibaba_group_alibaba_cloud_qwen/fallback_lobehub/png_light/qwen-color.png';
import runwayIconDark from '@resources/icons/model_providers/24_runway/fallback_lobehub/png_dark/runway.png';
import runwayIconLight from '@resources/icons/model_providers/24_runway/fallback_lobehub/png_light/runway.png';
import stabilityAiIconDark from '@resources/icons/model_providers/27_stability_ai/fallback_lobehub/png_dark/stability-color.png';
import stabilityAiIconLight from '@resources/icons/model_providers/27_stability_ai/fallback_lobehub/png_light/stability-color.png';
import sunoIconDark from '@resources/icons/model_providers/33_suno/fallback_lobehub/png_dark/suno.png';
import sunoIconLight from '@resources/icons/model_providers/33_suno/fallback_lobehub/png_light/suno.png';
import tencentHunyuanIconDark from '@resources/icons/model_providers/13_tencent_hunyuan/fallback_lobehub/png_dark/hunyuan-color.png';
import tencentHunyuanIconLight from '@resources/icons/model_providers/13_tencent_hunyuan/fallback_lobehub/png_light/hunyuan-color.png';
import xaiIconDark from '@resources/icons/model_providers/05_xai/fallback_lobehub/png_dark/xai.png';
import xaiIconLight from '@resources/icons/model_providers/05_xai/fallback_lobehub/png_light/xai.png';
import zaiIconDark from '@resources/icons/model_providers/11_z_ai_zhipu_ai/fallback_lobehub/png_dark/zai.png';
import zaiIconLight from '@resources/icons/model_providers/11_z_ai_zhipu_ai/fallback_lobehub/png_light/zai.png';
