...
export const MODEL_SERVICE_DEFINITIONS: readonly ModelServiceDefinition[] = [
	{
		...
		icon: Bot,
		required: true,
		getSelection: () => window.app.getAgentService(),
		getModels: (provider) => window.app.getModels(provider),
		saveSelection: (provider, model) => window.app.saveAgentService(provider, model),
	},
	{
		...
		icon: Mic,
		required: false,
		getSelection: () => window.app.getSpeechTranscriberService(),
		getModels: (provider) => window.app.getSpeechToTextModels(provider),
		saveSelection: (provider, model) => window.app.saveSpeechTranscriberService(provider, model),
	},
	{
		...
		icon: Volume2,
		required: false,
		getSelection: () => window.app.getTextToSpeechService(),
		getModels: (provider) => window.app.getTextToSpeechModels(provider),
		saveSelection: (provider, model) => window.app.saveTextToSpeechService(provider, model),
	},
	{
		...
		icon: ImageIcon,
		required: false,
		getSelection: () => window.app.getImageCreatorService(),
		getModels: (provider) => window.app.getImageCreatorModels(provider),
		saveSelection: (provider, model) => window.app.saveImageCreatorService(provider, model),
	},
	{
		...
		icon: Video,
		required: false,
		getSelection: () => window.app.getTextToVideoService(),
		getModels: (provider) => window.app.getTextToVideoModels(provider),
		saveSelection: (provider, model) => window.app.saveTextToVideoService(provider, model),
	},
	{
		...
		icon: Music,
		required: false,
		getSelection: () => window.app.getTextToSoundService(),
		getModels: (provider) => window.app.getTextToSoundModels(provider),
		saveSelection: (provider, model) => window.app.saveTextToSoundService(provider, model),
	},
];
