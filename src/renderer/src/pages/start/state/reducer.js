...
export function setupReducer(state, action) {
    switch (action.type) {
        ...
        case 'UPDATE_PROVIDER_ENTRY':
            return {
                ...state,
                providerEntries: state.providerEntries.map((entry) => entry.providerId === action.providerId ? { ...entry, ...action.patch } : entry),
            };
        ...
        case 'MARK_PROVIDERS_SAVED': {
            ...
            return {
                ...state,
                providerEntries: state.providerEntries.map((entry) => savedSet.has(entry.providerId)
