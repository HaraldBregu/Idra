...
import { Edit3, Plug, RefreshCw, TestTube2, Trash2 } from 'lucide-react';
	...
	return (
		<Card className="gap-0 py-0">
			<CardContent className="flex flex-col gap-4 p-4">
					...
					<div className="flex min-w-0 items-start gap-3">
						...
						<div className="min-w-0">
							...
							<div className="mt-2 flex flex-wrap items-center gap-2">
								...
								<ConnectorStatusBadge status={connector.connectionStatus} />
							</div>
						</div>
					</div>
				...
				<div className="grid gap-3 rounded-lg border border-border/70 bg-muted/20 p-3 text-xs text-muted-foreground sm:grid-cols-2">
					<div>
