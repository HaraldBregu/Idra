import { mergeModelCatalogs, model } from './types';
...
export const CHAT_MODELS_BY_PROVIDER = mergeModelCatalogs(LLM_MODELS_BY_PROVIDER, RESEARCH_CHAT_MODELS_BY_PROVIDER);
