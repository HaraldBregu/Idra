import { model, normalizeProviderId } from './types';
...
function resolveSpeechToTextProviderId(providerId) {
    ...
    return SPEECH_TO_TEXT_PROVIDER_IDS.includes(normalizedProviderId)
        ? normalizedProviderId
        : null;
}
export function isSpeechToTextProviderId(providerId) {
    return resolveSpeechToTextProviderId(providerId) !== null;
}
export function getSpeechToTextModelApiTypes(providerId, modelId) {
...
export function supportsSpeechToTextModelApiType(providerId, modelId, apiType) {
