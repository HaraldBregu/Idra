...
export const PROVIDER_API_CONFIGURATIONS = {
    ...
    google: {
        ...
        authMethod: 'API key parameter/header for Gemini Developer API; Google Cloud IAM/auth for Vertex/Cloud APIs',
    ...
    kling: {
        ...
        configurationDocsUrl: 'https://app.klingai.com/global/dev/document-api/quickStart/productIntroduction/overview',
    ...
    pika: {
        credentialType: 'Fal API key for official Pika API access via Fal; third-party Pika keys also exist',
...
export function getProviderApiConfigurationUrl(provider) {
    return (provider.apiConfiguration?.apiKeyManagementUrl?.trim() ||
        provider.apiConfiguration?.configurationDocsUrl?.trim() ||
        provider.baseUrl.trim());
}
function providerCapabilityTokens(provider) {
...
export function providerHasImageCapability(provider) {
    return providerHasCapability(provider, 'Image');
}
export function hasDefaultProviderCapability(providerId, capability) {
