...
export interface AgentInvokeChannelMap {
	...
	[AgentChannels.mcpList]: { args: []; result: import('./mcp.types').McpSettings };
	[AgentChannels.mcpGet]: { args: [id: string]; result: import('./mcp.types').McpSettings };
	[AgentChannels.mcpSave]: { args: [input: import('./mcp.types').McpSettings]; result: import('./mcp.types').McpSettings };
	[AgentChannels.mcpDelete]: { args: [id: string]; result: void };
	[AgentChannels.mcpOauthStart]: { args: [id: string]; result: import('./mcp.types').McpOAuthStart };
