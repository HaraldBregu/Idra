...
import type { ChannelsEventChannelMap, ChannelsInvokeChannelMap } from './channels/channels';
...
import type { WindowEventChannelMap, WindowInvokeChannelMap, WindowSendChannelMap } from './channels/window';
export interface InvokeChannelMap extends AppInvokeChannelMap, AgentInvokeChannelMap, ProviderStoreInvokeChannelMap, WindowInvokeChannelMap, CronInvokeChannelMap, HeartbeatInvokeChannelMap, SkillsInvokeChannelMap, ChannelsInvokeChannelMap, ConnectorsInvokeChannelMap, SttInvokeChannelMap {
}
export interface SendChannelMap extends WindowSendChannelMap {
}
export interface EventChannelMap extends AgentEventChannelMap, WindowEventChannelMap, ChannelsEventChannelMap, CronEventChannelMap, HeartbeatEventChannelMap, SttEventChannelMap {
}
