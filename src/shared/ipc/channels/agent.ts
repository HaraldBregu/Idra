...
export interface AgentInvokeChannelMap {
	...
	[AgentChannels.healthSettings]: { args: []; result: import('../../../main/agent/health/health-store').HealthSettings };
	[AgentChannels.healthSaveSettings]: {
		args: [request: Partial<import('../../../main/agent/health/health-store').HealthSettings>];
		result: import('../../../main/agent/health/health-store').HealthSettings;
	};
	[AgentChannels.healthResetSettings]: { args: []; result: import('../../../main/agent/health/health-store').HealthSettings };
