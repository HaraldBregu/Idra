...
export type AgentRunState = 'idle' | 'thinking' | 'reasoning' | 'using_tools' | 'answering' | 'completed' | 'cancelled' | 'error';
export type ReasoningSummaryState = 'pending' | 'running' | 'completed' | 'error';
export type AgentRunStopReason = 'end_turn' | 'max_tokens' | 'max_iterations' | 'error' | 'cancelled';
...
export type AgentCapabilityDecisionMode = 'direct_answer' | 'use_tools' | 'use_skills' | 'use_tools_and_skills';
