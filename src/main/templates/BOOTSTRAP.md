...
- Delete this file using the `exec` tool with command `rm <workspace>/BOOTSTRAP.md`, where `<workspace>` is the absolute path from the system prompt (e.g. `.friday/assistant/workspaces/main/BOOTSTRAP.md`)
