import type { ToolPolicyServicePort } from '../policy';
...
function filePolicy(ctx: ToolContext): ToolPolicyServicePort | undefined {
	return (ctx.services as { policy?: ToolPolicyServicePort } | undefined)?.policy;
}
