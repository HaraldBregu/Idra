...
import type { RendererContentOptions, WindowFactory } from '../kernels/window-factory';
import type { WindowContextManager } from '../kernels/window-context';
import type { MainServices } from '../kernels/services';
