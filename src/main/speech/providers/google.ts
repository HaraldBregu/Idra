import { ensureSpeechResponseOk, speechResult } from '../audio';
import { SpeechProviderRequestError } from '../errors';
import type { SpeechAdapter, SpeechAdapterRequest, SpeechProviderSpec } from '../types';
