import { CHANNEL_PROVIDER_IDS, type ChannelType } from '../../shared/channels';
...
const CHANNEL_CATALOG_INPUT: readonly ChannelCatalogInput[] = [
	...
	entry('googlechat', 'Google Chat', 'Connect Google Chat spaces and DMs.', ['gchat', 'google-chat'], 40, true),
