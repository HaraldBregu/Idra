import type { AgentTool, AgentToolResult, ToolDiagnostics } from './common';
import {
	getToolMetadata,
...
import { wrapToolWithBeforeToolCall, type BeforeToolCallContext } from './before-tool-call';
import { coerceJsonObject } from './params';
import { errorToolResult } from './results';
