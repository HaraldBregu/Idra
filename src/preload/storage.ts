...
export const storage: StorageApi = {
	...
	getSyncSettings: () => typedInvokeUnwrap(StorageChannels.getSyncSettings),
	saveSyncSettings: (settings) => typedInvokeUnwrap(StorageChannels.saveSyncSettings, settings),
};
